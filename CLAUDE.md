...
| 2 — Community Features     | Search (Typesense, decided), object storage decision, Communities, Channels, Stories, push notifications           | In progress (Communities complete; Channels CH1 + CH1b + CH2 backend on `feature/phase-2-channels`, mobile partial)               |
